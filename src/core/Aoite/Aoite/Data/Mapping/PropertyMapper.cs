...
namespace Aoite.Data
{
    ...
    /// 表示一个属性的映射器。
    /// </summary>
    public class PropertyMapper : DynamicProperty, IMapper
    {
        ...
        /// 获取属性所属的实体映射器。
        /// </summary>
        public IEntityMapper Entity { get { return this._Entity; } }
            ...
            : base(property)
        {
            ...
            this._Entity = entity;
            this._IsIgnore = property.IsDefined(IgnoreAttribute.Type, true);

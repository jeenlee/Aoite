...
namespace fastJSON
{
    ...
    internal sealed class Reflection
    {
        ...
        {
            if(_customSerializer.Count == 0) return false;
            Serialize s;
        ...
        internal static GenericSetter CreateSetMethod(Type type, PropertyInfo propertyInfo)
        {
            ...
            DynamicMethod setter = new DynamicMethod("_", typeof(object), arguments, true);
        ...
        internal static GenericGetter CreateGetMethod(Type type, PropertyInfo propertyInfo)
        {
            ...
            DynamicMethod getter = new DynamicMethod("_", typeof(object), new Type[] { typeof(object) }, type, true);

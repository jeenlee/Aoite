...
namespace fastJSON
{
    ...
    {
        /// <summary>
        /// Use the optimized fast Dataset Schema format (default = False)
        /// </summary>
        ...
        /// <summary>
        /// Ignore case when processing json and deserializing (default = True)
        /// </summary>
        public bool IgnoreCaseOnDeserialize = true;
        /// <summary>
        ...
        /// </summary>
        public List<Type> IgnoreAttributes = new List<Type> { IgnoreAttribute.Type };
        /// <summary>
    ...
    public static class JSON
    {
        ...
        /// 表示最大的 JSON 数字值。
        /// </summary>
        public const long MaxNumber = 9007199254740992;
        /// <summary>
        /// 表示最小的 JSON 数字值。
        /// </summary>
        public const long MinNumber = -9007199254740992;
        /// <summary>
        ...
        internal static object ToObject(Dictionary<string, object> d, Type type)
        {
            return new deserializer(Parameters).ParseDictionary(d, null, type, null);
        }
        internal static object ToObject(List<object> d, Type type)
        {
            return new deserializer(Parameters).CreateArray(d, null, type.GetElementType(), null);
        }
        /// <summary>
    ...
    internal class deserializer
    {
        ...
        private object GetObject(object o, Type type)
        {
            Type t = null;
...
#endif
            if(this.IsResultType(o, type))
                return ToResult(o, type);
            if(o is IDictionary)
            {
        ...
        public object ToObject(string json, Type type)
        {
            ...
            if(type == null
                || (o != null && (o.GetType() == type))) return o;
            return GetObject(o, type);
        }
        ...
        private bool IsResultType(object value, Type conversionType)
        {
            return value is Dictionary<string, object> && (Types.Result == conversionType || conversionType.IsSubclassOf(Types.Result));
        }
        private object ToResult(object value, Type conversionType)
        {
            var dic = value as Dictionary<string, object>;
            Result result;
            result = Reflection.Instance.FastCreateInstance(conversionType) as Result;
            object o;
            var valueType = result.GetValueType();
            if(dic.TryGetValue("status", out o) && o != null)
                result._Status = Convert.ToInt32(o);
            if(dic.TryGetValue("message", out o) && o != null)
                result._Message = Convert.ToString(o);
            if(valueType != null && dic.TryGetValue("value", out o) && o != null)
            {
                result.SetValue(GetObject(o, valueType));
            }
            return result;
        }
        private object ChangeType(object value, Type conversionType)
        {
            if(conversionType == typeof(int))
                ...
                return long.Parse(Convert.ToString(value));
            else if(conversionType == typeof(ulong))
                return ulong.Parse(Convert.ToString(value));
            ...
            if(this.IsResultType(value, conversionType))
                return ToResult(value, conversionType);
            try
            {
        ...
        internal object ParseDictionary(Dictionary<string, object> d, Dictionary<string, object> globaltypes, Type type, object input)
        {
            ...
            {
                _usingglobals = true;
                globaltypes = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
            ...
            foreach(string n in d.Keys)
            {
                ...
                {
                    object v = d[name];
                    if(v is string && ((string)v).Length == 0) v = null;
                    if(v != null)
                    {
                        object oset = null;
                        ...
                        switch(pi.Type)
                        {
                            ...
                            case myPropInfoType.Long: oset = long.Parse(Convert.ToString(v)); break;
        ...
        private DateTime CreateDateTime(string value)
        {
            ...
            if(value.Length > 10) CreateInteger(out hour, value, 11, 2);
            if(value.Length > 13) CreateInteger(out min, value, 14, 2);
            if(value.Length > 16) CreateInteger(out sec, value, 17, 2);
        ...
        internal object CreateArray(List<object> data, Type pt, Type bt, Dictionary<string, object> globalTypes)
        {

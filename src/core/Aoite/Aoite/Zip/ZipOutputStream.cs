...
namespace Aoite.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = Aoite.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="Aoite.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Aoite.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="Aoite.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private Aoite.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public Aoite.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {

...
namespace Aoite.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = Aoite.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = Aoite.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="Aoite.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)Aoite.Zip.CompressionMethod.None)
                    _CompressionLevel = Aoite.Zlib.CompressionLevel.None;
                else if (CompressionLevel == Aoite.Zlib.CompressionLevel.None)
                    _CompressionLevel = Aoite.Zlib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        public Aoite.Zlib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == Aoite.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == Aoite.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == Aoite.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) Aoite.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) Aoite.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </exception>
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.Password">ZipEntry.Password</seealso>
        /// <seealso cref="Aoite.Zip.ZipFile.Encryption">ZipFile.Encryption</seealso>
        ...
        /// </example>
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.Encryption"/>
        /// <seealso cref="Aoite.Zip.ZipFile.Password">ZipFile.Password</seealso>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Aoite.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Aoite.Zip.ZipFile.ZipErrorAction"/>
        /// <seealso cref="Aoite.Zip.ZipFile.ZipError"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = Aoite.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new Aoite.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new Aoite.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                Aoite.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private Aoite.Zlib.CompressionLevel _CompressionLevel;

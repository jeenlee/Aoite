...
namespace Aoite.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Aoite.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Aoite.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="Aoite.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="Aoite.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Aoite.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="Aoite.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="Aoite.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        /// </code>
        /// </example>
        /// <seealso cref="Aoite.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public Aoite.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
            ...
            long uncompressedSize)
        {
            ...
            try
            {
                ...
                // workitem 10178
                Aoite.Zip.SharedUtilities.Workaround_Ladybug318918(input);
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = Aoite.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);

...
namespace Aoite.Zip
{
    ...
    public enum ZipEntrySource
    {
        ...
        /// <summary>
        /// The entry was instantiated via <see cref="Aoite.Zip.ZipFile.AddEntry(string,string)"/> or
        /// <see cref="Aoite.Zip.ZipFile.AddEntry(string,System.IO.Stream)"/> .
        /// </summary>
        Stream,
        ...
        /// The entry was instantiated via <see cref="Aoite.Zip.ZipFile.AddEntry(string,OpenDelegate,CloseDelegate)"/>.
        /// </summary>
        JitStream,

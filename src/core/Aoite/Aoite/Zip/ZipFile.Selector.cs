...
namespace Aoite.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Aoite.FileSelector ff = new Aoite.FileSelector(selectionCriteria,
...
namespace Aoite
{
    ...
    {
        internal abstract bool Evaluate(Aoite.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Aoite.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Aoite.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Aoite.Zip.ZipEntry> SelectEntries(Aoite.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Aoite.Zip.ZipEntry>();

            foreach (Aoite.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Aoite.Zip.ZipEntry> SelectEntries(Aoite.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

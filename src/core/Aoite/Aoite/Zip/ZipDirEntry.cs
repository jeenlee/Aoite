...
namespace Aoite.Zip
{
    ...
    partial class ZipEntry
    {
            ...
            get
            {
                ...
                if (this._RelativeOffsetOfLocalHeader > 0xFFFFFFFF)
                    ...
                    .Append(string.Format("          Timeblob: 0x{0:X8}\n", this._TimeBlob))
                        .Append(string.Format("              Time: {0}\n", Aoite.Zip.SharedUtilities.PackedToDateTime(this._TimeBlob)));
                                              ...
                                              Dictionary<String,Object> previouslySeen)
        {
            ...
            int signature = Aoite.Zip.SharedUtilities.ReadSignature(s);
            ...
            unchecked
            {
                ...
                zde._LastModified = Aoite.Zip.SharedUtilities.PackedToDateTime(zde._TimeBlob);
            ...
            {
                // UTF-8 is in use
                zde._FileNameInArchive = Aoite.Zip.SharedUtilities.Utf8StringFromBuffer(block);
            }
            else
            {
                zde._FileNameInArchive = Aoite.Zip.SharedUtilities.StringFromBuffer(block, expectedEncoding);
            }
            ...
            if (zde._commentLength > 0)
            {
                ...
                {
                    // UTF-8 is in use
                    zde._Comment = Aoite.Zip.SharedUtilities.Utf8StringFromBuffer(block);
                }
                else
                {
                    zde._Comment = Aoite.Zip.SharedUtilities.StringFromBuffer(block, expectedEncoding);
                }
            }

...
namespace Aoite.Zip
{
    ...
    ///   cref="Aoite.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="Aoite.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="Aoite.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="Aoite.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="Aoite.Zip.ZipFile.SetCompression"/>
    public delegate Aoite.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);

...
namespace Aoite.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        /// </remarks>
        ///
        /// <seealso cref="Aoite.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="Aoite.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>

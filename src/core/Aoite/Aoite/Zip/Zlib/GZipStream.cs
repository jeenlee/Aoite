...
namespace Aoite.Zlib
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == Aoite.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == Aoite.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == Aoite.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {

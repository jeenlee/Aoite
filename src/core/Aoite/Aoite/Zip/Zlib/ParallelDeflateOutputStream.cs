...
namespace Aoite.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        Aoite.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="Aoite.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="Aoite.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private Aoite.Crc.CRC32             _runningCrc;
        ...
        private Aoite.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="Aoite.Zlib.DeflateStream"/>,
        ...
        ///   cref="Aoite.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new Aoite.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="Aoite.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                Aoite.Crc.CRC32 crc = new Aoite.Crc.CRC32();
